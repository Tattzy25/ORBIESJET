...
export const ShaderCanvas = ({ 
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const mousePos: [number, number] = [0.5, 0.5]; // Always use center position for centered blur effects
      ...
      drawScene(
        ...
        canvas.width, 
        canvas.height, 
        mousePos // Pass center position for centered effects
      );
  ...
  function drawScene(
    ...
    // Enable center dimming to create the blur effect in the center
